        ...
        <div className="side-bar-content">
            ...
            <div style={{display:"flex",flexDirection:"column",marginLeft:"0.5rem"}}>
                ...
                <div className="tasktype-container">
                    ...
                    <div style={{borderRadius:"0.5rem",padding:"0.5vw",margin:"0.5vw",background:"#2f80ed",cursor:"pointer"}}  onClick={()=>{props.showTaskType(['Personal','Official','Miscellaneous'])}} >
                     All 
                </div>
                <div style={{borderRadius:"0.5rem",padding:"0.5vw",margin:"0.5vw",background:"#21ba45",cursor:"pointer"}} onClick={()=>{props.showTaskType(['Personal'])}} >
                    Personal 
                </div>
          
                </div>
                <div>
            <div style={{borderRadius:"0.5rem",padding:"0.5vw",margin:"0.5vw",background:"#9b51e0",cursor:"pointer"}}  onClick={()=>{props.showTaskType(['Official'])}} >
                    Official 
                </div>
                <div style={{borderRadius:"0.5rem",padding:"0.5vw",margin:"0.5vw",background:"#f2994a",cursor:"pointer"}} onClick={()=>{props.showTaskType(['Miscellaneous'])}} >
                    Misc.
                </div>
                </div>
                </div>
